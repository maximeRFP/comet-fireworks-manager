...
@Component({
    selector   : 'rfp-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : rfpAnimations
})
export class RfpNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._rfpNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._rfpNavigationService.onItemCollapsed.next(this.item);
        this._rfpNavigationService.onItemCollapseToggled.next();
    }
