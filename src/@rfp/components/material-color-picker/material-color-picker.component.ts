...
import { MatColors } from '@rfp/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const RFP_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => RfpMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'rfp-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : rfpAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [RFP_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class RfpMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, rfp-navy-700 etc.)
