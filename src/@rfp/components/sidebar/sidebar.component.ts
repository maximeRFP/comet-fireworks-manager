...
import { RfpSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'rfp-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class RfpSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._rfpConfigService.config
            ...
            .subscribe((config) => {
                this._rfpConfig = config;
            });

        // Register the sidebar
        this._rfpSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._rfpSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('rfp-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('rfp-sidebar-overlay-invisible');
        }
