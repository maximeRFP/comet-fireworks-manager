...
import '@rfp/components/highlight/prism-languages';

@Component({
    selector : 'rfp-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class RfpHighlightComponent implements OnInit, OnDestroy
{
    // Source
    @ContentChild('source')
    source: ElementRef;
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using rfp-highlight
        // component
