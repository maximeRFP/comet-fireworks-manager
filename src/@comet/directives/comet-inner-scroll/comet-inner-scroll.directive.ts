...
export class CometInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {CometMatchMediaService} _cometMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _cometMediaMatchService: CometMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._cometMediaMatchService.onMediaChange
