...
@Directive({
    selector: '[cometPerfectScrollbar]'
})
export class CometPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set cometPerfectScrollbarOptions(value)
    {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get cometPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.cometPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.cometPerfectScrollbarOptions
        });
