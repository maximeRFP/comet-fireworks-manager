...
import '@comet/components/highlight/prism-languages';

@Component({
    selector : 'comet-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class CometHighlightComponent implements OnInit, OnDestroy
{
    // Source
    @ContentChild('source')
    source: ElementRef;
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using comet-highlight
        // component
