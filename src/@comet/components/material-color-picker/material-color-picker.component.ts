...
import { cometAnimations } from '@comet/animations';
import { MatColors } from '@comet/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const COMET_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => CometMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'comet-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : cometAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [COMET_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class CometMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, comet-navy-700 etc.)
