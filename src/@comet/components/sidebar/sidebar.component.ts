...
import { CometSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'comet-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class CometSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._cometConfigService.config
            ...
            .subscribe((config) => {
                this._cometConfig = config;
            });

        // Register the sidebar
        this._cometSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._cometSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('comet-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('comet-sidebar-overlay-invisible');
        }
