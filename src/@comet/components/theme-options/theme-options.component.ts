...
@Component({
    selector     : 'comet-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : cometAnimations
})
export class CometThemeOptionsComponent implements OnInit, OnDestroy
{
    cometConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._cometConfigService.config = config;
            });
        ...
        this._cometNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._cometNavigationService.removeNavigationItem('custom-function');
    }
