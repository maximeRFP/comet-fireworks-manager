...
@Component({
    selector     : 'comet-widget',
    templateUrl  : './widget.component.html',
    styleUrls    : ['./widget.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class CometWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(CometWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<CometWidgetToggleDirective>;
