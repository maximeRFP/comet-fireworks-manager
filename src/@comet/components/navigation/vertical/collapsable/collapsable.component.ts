...
@Component({
    selector   : 'comet-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : cometAnimations
})
export class CometNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._cometNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._cometNavigationService.onItemCollapsed.next(this.item);
        this._cometNavigationService.onItemCollapseToggled.next();
    }
